export const SpaceRegistryAbi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IEstateRegistry",
        name: "",
        type: "address",
      },
    ],
  ...
  },
  {
    ...
    name: "transferSpaceManyToEstate",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
